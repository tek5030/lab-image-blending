...
void runImageBlendingLab()
{
  ...
  // We have copied the image files to the build directory as part of the project configuration,
  // so using the filenames directly such as "tiger.png" should work.
  // Remember to rescale so that they have values in the interval [0, 1].
  // Hint: cv::Mat::convertTo().
  cv::Mat img_1;
  // your code here
  showResult("Image 1 original", img_1);

  cv::Mat img_2;
  // your code here
  showResult("Image 2 original", img_2);
